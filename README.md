...
New filename.flex files can be compiled by using a command and running the command "jflex filename.flex" to turn them into filename.java files. New filename.cup files can be compiled by using a command and running the command "cup filename.cup" to turn them into parser.java and sym.java files.
